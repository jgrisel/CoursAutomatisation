...
CREATE TABLE material_assigment (id BIGINT NOT NULL, version BIGINT NOT NULL, units DECIMAL(19,2), unit_price DECIMAL(19,2), material_id BIGINT, estimated_availability TIMESTAMP WITH TIME ZONE, status INT, order_element_id BIGINT, CONSTRAINT material_assignment_pkey PRIMARY KEY (id));
...
CREATE TABLE material_assigment_template (id BIGINT NOT NULL, version BIGINT NOT NULL, units DECIMAL(19,2), unit_price DECIMAL(19,2), material_id BIGINT, order_element_template_id BIGINT, CONSTRAINT material_assignment_template_pkey PRIMARY KEY (id));
...
CREATE TABLE work_report_label_type_assigment (id BIGINT NOT NULL, version BIGINT NOT NULL, labels_shared_by_lines BOOLEAN, position_number INT, label_type_id BIGINT, label_id BIGINT, work_report_type_id BIGINT, CONSTRAINT work_report_label_type_assignment_pkey PRIMARY KEY (id));
...
ALTER TABLE task ADD CONSTRAINT task_subcontracted_task_data_id_key UNIQUE (subcontrated_task_data_id);
...
ALTER TABLE subcontractor_deliver_date ADD subcontrated_task_data_id BIGINT;
...
ALTER TABLE end_date_communication_to_customer ADD subcontrated_task_data_id BIGINT;

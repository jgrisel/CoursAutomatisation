...
public class PersonnelAdministratif extends Personne implements EmployeEcole{
	...
	public int getAbsenceMois() {
		System.out.println("L'employé administratif comptabilise "+ nb_absences_mois_en_cours + " absences ce mois-ci");
	...
	public void demanderAugmentation(Ecole ecole, EmployeEcole admin,  double augmentationSouhaitee) {
		System.out.println("le membre du personnel administratif demande un nouveau salaire à hauteur de " + augmentationSouhaitee );
